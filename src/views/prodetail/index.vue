  ...
  <div class="prodetail">
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in evaluateList" :key="item.comment_id">
          <div class="top">
...
import { getProDetail, getProductEva } from '@/api/product'
...
export default {
  ...
  methods: {
    ...
    // 商品评论
    async getProductEva () {
      const { data: { list, total } } = await getProductEva(this.goodsId, 3)
